...
from PyQt5.QtWidgets import QGridLayout, QPushButton,QProgressBar, QDialog, QLabel, QApplication, QWidget, QVBoxLayout, QListView, QTableWidget, QHBoxLayout, QAbstractItemView, QTableWidgetItem
...
class Ui_MainWindow(object):
    ...
    def buttons(self):
        layout = QGridLayout()
        button1 = QPushButton("輸入影片")
        button2 = QPushButton("選擇影片")
...
class targettable(QWidget):
    ...
    def initUi(self):
        ...
        for k in range(files_num):
            i=k/5
            j=k%5
            item = QTableWidgetItem(DIR+'_all/' + target_dir +'_%d.jpg'%k)
